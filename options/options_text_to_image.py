...
class OptionsTextToImage(Options):
    ...
    def __init__(
        ...
        :param timesteps (`List[int]`, *optional*):
            Custom timesteps to use for the denoising process with schedulers
            which support a `timesteps` argument in their `set_timesteps`
            method. If not defined, the default behavior when
            `num_inference_steps` is passed will be used.
            Must be in descending order.
        :param denoising_end (`float`, *optional*):
            When specified, determines the fraction (between 0.0 and 1.0) of
            the total denoising process to be completed before it is
            intentionally prematurely terminated.
        ...
        :param negative_prompt_2 (`str` or `List[str]`, *optional*):
            The prompt or prompts not to guide the image generation to be sent
            to `tokenizer_2` and `text_encoder_2`. If not defined,
        ...
        :param generator (`torch.Generator` or `List[torch.Generator]`,
            *optional*):
        ...
        :param latents (`torch.FloatTensor`, *optional*):
            ...
            tensor will be generated by sampling using the supplied random
            generator.
        :param prompt_embeds (`torch.FloatTensor`, *optional*):
            ...
            will be generated from `prompt` input argument.
        :param negative_prompt_embeds (`torch.FloatTensor`, *optional*):
            Pre-generated negative text embeddings. Can be used to easily tweak
            text inputs, *e.g.* prompt weighting. If not provided,
            negative_prompt_embeds will be generated from `negative_prompt`
            input argument.
        :param pooled_prompt_embeds (`torch.FloatTensor`, *optional*):
            Pre-generated pooled text embeddings. Can be used to easily tweak
        ...
        :param return_dict (`bool`, *optional*, defaults to `True`):
            Whether or not to return a StableDiffusionXLPipelineOutput instead
             of a plain tuple.
        ...
        :param negative_original_size
            ...
            image resolution. Part of SDXL's micro-conditioning as explained in
            section 2.2 of the documentation.
        :param negative_crops_coords_top_left
            (`Tuple[int]`, *optional*, defaults to (0, 0)):
            To negatively condition the generation process based on specific
            crop coordinates. Part of SDXL's micro-conditioning as explained in
             section 2.2 of the documentation.
        ...
        if callback_on_step_end_tensor_inputs:
            self.callback_on_step_end_tensor_inputs = (
